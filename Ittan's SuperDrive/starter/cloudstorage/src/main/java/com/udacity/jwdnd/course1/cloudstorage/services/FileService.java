...
public class FileService {
    ...
    public void addFile(MultipartFile fileUpload, int userid) throws IOException {
        ...
        try {
            ...
            throw new IOException("Error processing file upload.", e);
        }
    ...
    public Optional<File> getFile(String filename, Integer userid) {
        return Optional.ofNullable(fileMapper.getFile(userid, filename));
    }
